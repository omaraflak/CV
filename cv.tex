...
\begin{document}
    ...
    \begingroup
        \begin{minipage}[t]{\linegoal}
            \footnotesize{\link{https://github.com/omaraflak}{GitHub}}: 110+ public repositories \\
    ...
    \experience{Dec 2021}{\textit{present}}{Google}{Software Engineer}{London}{
        Launched the \link{https://play.google.com/console/about/deeplinks}{Deep Links} page in Play Console. Developed several data pipelines, that are time sensitive and critical to the project; those pipelines process data coming from 500M Android devices, or 26B messages daily. Project led to 12\% of App Links domains being fixed.
        Filled a stream of revenue by \$xxM. Designed and implemented end to end patching feature for Android Deeplinks.
    }
    \newsectionspace
    \experience{Feb 2021}{Aug 2021}{Criteo}{Software Engineer, Data}{Paris}{
