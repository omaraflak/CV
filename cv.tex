...
\begin{document}
    ...
    \experience{Dec 2021}{\textit{present}}{Google}{Software Engineer}{London}{
        Launched the \link{https://play.google.com/console/about/deeplinks}{Deep Links} page in Play Console. Worked on backend and front. Logged data in GMSCore (4.4B devices) and developed a pipeline to process the 2B logs incoming daily.
