...
\begin{document}
    ...
    \begingroup
        \begin{minipage}[t]{\linegoal}
            \footnotesize{\link{https://github.com/omaraflak}{GitHub}}: 100+ public repositories \\
            \footnotesize{\link{https://medium.com/@omaraflak}{Medium}}: 12 articles, many in \textit{Towards Data Science} \\
            \footnotesize{\link{https://www.youtube.com/@independentcode}{YouTube}}: 4 videos, Machine Learning \\
            \footnotesize{\link{https://stackoverflow.com/users/5552022/omar-aflak}{StackOverflow}}: 130+ answers
        \end{minipage}
    \endgroup
    ...
    \experience{Dec 2021}{\textit{present}}{Google}{Software Engineer}{London, UK}{
        \begin{itemize}
            \item Launched the \link{https://play.google.com/console/about/deeplinks}{Deep Links} page in Play Console. Developed several critical, time sensitive data pipelines responsible for processing data coming from 1.4B Android devices daily, or xxB messages daily. Project led to the fix of ~20\% of App Links domains. Increased a stream of revenue by \$xxM.
    ...
    \newsectionspace
    \project{2023}{Machine Learning Library}{
        A machine learning library developed from scratch in Python, that allows the creation of models as graphs of layers. This makes the library very versatile, and able to represent a wide variety of architectures. I used it for instance to successfully train CNNs and GANs. \link{https://github.com/omaraflak/neglnn2}{Neglnn 2 - GitHub}.
    }
    \newsectionspace
