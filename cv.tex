...
\begin{document}
    ...
    \experience{Dec 2021}{\textit{present}}{Google}{Software Engineer}{London}{
        Launched the \link{https://play.google.com/console/about/deeplinks}{Deep Links} page in Play Console. Logged data in GMSCore (>4B devices) and developed distributed data pipelines to process 2B logs incoming daily. Led to 10\% of App Links domains being fixed. Filled a stream of revenue by \$xxM.
        \textit{More work in progress...}
    }
    \newsectionspace
